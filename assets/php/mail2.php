...
if(isset($_POST['email'])) {
    ...
    $city_name = $_POST['cita']; // required
    $telephone = $_POST['telefono']; // required
    $email_form = $_POST['email']; // not required
  ...
  if(!preg_match($string_exp,$city_name)) {
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "City Name: ".clean_string($city_name)."\n";
